      ...
      <section id="sobre" className="py-24 px-4 bg-linear-to-b from-white to-emerald-50/30 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              { icon: Recycle, title: 'Reciclagem Consciente', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', delay: 0 },
              { icon: Leaf, title: 'Meio Ambiente', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', delay: 0.1 },
              { icon: Heart, title: 'Impacto Social', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', delay: 0.2 }
            ].map((item, index) => {
          ...
          >
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              Ut ornare, odio bibendum tincidunt sagittis, felis lacus condimentum dolor, in hendrerit ante leo ut tortor
            </p>
          </div>
        </div>
      </section>
